...
import { API, Area, Body13, Category, InlineResponse2009, IResponse, Region } from '../api';
...
export class NearStore extends BaseChildStore {
  ...
  @action public requestGetRegions(cityId: number) {
